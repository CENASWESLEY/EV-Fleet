class Assistant_Right extends HTMLElement {
        ...
        <div class="assistant_right-circle">
          <div class="assistant_right-circle-group_icon">
            <div class="assistant_right-circle-icon">
              <a href="../../4.Data_Analysis/Data_Analysis-First/Data_Analysis-First.html" data-icon="First">
                <img src="../../../assets/Data_Analysis/Assistant_right/First-active.png" alt="First">
              </a>
            </div>
            <div class="assistant_right-circle-icon">
              <a href="../../4.Data_Analysis/Data_Analysis-Second/Data_Analysis-Second.html" data-icon="Second">
                <img src="../../../assets/Data_Analysis/Assistant_right/Second-inactive.png" alt="Second">
              </a>
            </div>
            <div class="assistant_right-circle-icon">
              <a href="../../4.Data_Analysis/Data_Analysis-Third/Data_Analysis-Third.html" data-icon="Third">
                <img src="../../../assets/Data_Analysis/Assistant_right/Third-inactive.png" alt="Third">
              </a>
            </div>
          </div>
      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        icons.forEach(icon => {
            ...
            if (link.getAttribute("href").includes(currentPage)) {
                icon.src = `/assets/Data_Analysis/Assistant_right/${iconName}-active.png`;
                setActiveLabel(iconName);
            } else {
                icon.src = `/assets/Data_Analysis/Assistant_right/${iconName}-inactive.png`;
            }
  ...
  customElements.define("assistant-right-da", Assistant_Right);
