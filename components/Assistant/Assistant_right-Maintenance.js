class Assistant_Right extends HTMLElement {
        ...
        <div class="assistant_right-circle">
          <div class="assistant_right-circle-group_icon">
            <div class="assistant_right-circle-icon">
              <a href="../../5.Maintenance/Maintenance_First/Maintenance_First.html" data-icon="First">
                <img src="../../../assets/Maintenance/Assistant_right/First-active.png" alt="First">
              </a>
            </div>
            <div class="assistant_right-circle-icon">
              <a href="../../5.Maintenance/Maintenance_Second/Maintenance_Second.html" data-icon="Second">
                <img src="../../../assets/Maintenance/Assistant_right/Second-inactive.png" alt="Second">
              </a>
            </div>
            <div class="assistant_right-circle-icon">
              <a href="../../5.Maintenance/Maintenance_Third/Maintenance_Third.html" data-icon="Third">
                <img src="../../../assets/Maintenance/Assistant_right/Third-inactive.png" alt="Third">
              </a>
            </div>
          </div>
                  ...
                  <div class="assistant_right-circle-icon_box-second">
                    <div class="assistant_right-circle-icon_tooltip-second">
                        <p id="secondLabel">Transaction<br>Management </p>
                    </div>
                  </div>
      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        icons.forEach(icon => {
            ...
            if (link.getAttribute("href").includes(currentPage)) {
                icon.src = `/assets/Maintenance/Assistant_right/${iconName}-active.png`;
                setActiveLabel(iconName);
            } else {
                icon.src = `/assets/Maintenance/Assistant_right/${iconName}-inactive.png`;
            }
  ...
  customElements.define("assistant-right-m", Assistant_Right);
